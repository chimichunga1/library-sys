...
<div class="container">
	...
	<div class="row">
		...
		<form method="GET" action="search_circulation">   
            ...
            <tr>
                 ...
                 <td>{{ $book_list->title }}</td>
                  ...
                  <td>
                    ...
                    <a class="btn btn-primary col-md-3" data-toggle="modal" data-target="#approve{{ $book_list->id }}" style="color:white;"><i class="fa fa-check"></i></a>&nbsp;
                    <a class="btn btn-primary col-md-3" data-toggle="modal" data-target="#reject{{ $book_list->id }}" style="color:white;"><i class="fa fa-close"></i></a>
...
<div class="modal fade" id="approve{{ $book_list->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Approve Lending Request</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      ...
      <div class="modal-footer">
		...
		<form method="GET" action="{{ route('approveRequest') }}">   
...
<!-- Modal -->
<div class="modal fade" id="reject{{ $book_list->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Reject Lending Request</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      ...
      <div class="modal-footer">
		...
		<form method="GET" action="{{ route('rejectRequest') }}">   
