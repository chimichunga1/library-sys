...
<div class="btn-toolbar justify-content-between" role="toolbar" aria-label="Toolbar with button groups">
  <div class="btn-group" role="group" aria-label="First group">
		 	...
		 	&nbsp;<a class="btn btn-success" href="/accountUser"><i class="fa fa-plus"> Revert</i></a>
            ...
            <tr>
                 ...
                 <td>{{ $user->id }}</td>
                  ...
                  <td>
                    ...
                    <div class="row">
                    <a class="btn btn-primary col-md-6" href="/book_list/{{ $user->id }}/edit"><i class="fa fa-user"></i> View Profile</a> &nbsp;


{{--                     <a class="btn btn-primary col-md-5"><i class="fa fa-remove"></i></a> --}}
                    </div>
