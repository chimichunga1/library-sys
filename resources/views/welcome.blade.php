...
<div class="row no-gutters">
    ...
    <div class="container" style="color:white; padding: 40px;font-family: roboto; ">

        <H1 style="font-size: 62px;">READING CAN TAKE<P> YOU TO
         PLACES</P> YOU HAVE NEVER <p>BEEN BEFORE!</p></H1>
...
<div class="container col-md-5" style="background-color: white;">
            <div class="card">
                <div class="card-header" style="font-family: roboto; "><CENTER><h1>{{ __('Login') }} Now!</h1></CENTER></div>
<br>
