            ...
            <tr>
                 ...
                 <td>{{ $book_list->title }}</td>
                  ...
                  <td>
                    ...
                    <a class="btn btn-primary col-md-3" data-toggle="modal" data-target="#return{{ $book_list->id }}" style="color:white;"><i class="fa fa-check"></i></a>&nbsp;
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="col-md-6">
          ...
          <h4>Borrowed Date  {{ $book_list->borrowed_on }} </h4>
...
<!-- Modal -->
<div class="modal fade" id="return{{ $book_list->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Approve Return Request</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      ...
      <div class="modal-footer">
		...
		<form method="GET" action="{{ route('receiveRequest') }}">   
